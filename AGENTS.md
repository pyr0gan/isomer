...
- **Versioning:** tooling = `mix.exs` (currently **0.1.2**) + **merged PR descriptions** as the human history; content = per-file YAML `version` / framework edition directories — never Mix, and no GitHub Releases for content. Policy: `docs/versioning.md`. No `CHANGELOG.md`. Do not invent “content release” numbers.
